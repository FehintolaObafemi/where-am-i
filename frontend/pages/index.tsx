  ...
  return (
    <div>
      ...
      <div className='font-sans w-full' style={ { position: 'absolute', top: 0, left: 0 } }>
        ...
        <div className='flex flex-col md:flex-row items-center justify-center bg-blue-500 font-bold text-xl text-center w-full py-4 md:py-12'>
        ...
        <div className='block fixed font-bold text-center w-11/12 md:w-2/5 mx-auto my-8'>
          Inspired by the Sherlock Project. Created by Taofeek Obafemi-Babatunde.
        </div>
      </div>
    </div>
  );
